...
РаботаФСБ:
SendMessage, 0x50,, 0x4190419,, A
SendInput, {F6}/s Всем стоять, ФСБ{!} Задержание{!}
Sleep 1000
...
Sleep 1000
SendInput, {F6}Ваше право является реализованым.{Enter}
Sleep 1000
...
F9 & Numpad2::
    ExtendedInfo1("Что делает Numpad2:"
        ...
        , "| N2 + LMB: Оповестить о работе ФСБ в мегафон"
...
F9 & Numpad8::
    ExtendedInfo1("Что делает Numpad8:"
        ...
        , "| N8 + Ctrl: Адвоката нету в области"
...
F9 & 3::
    ExtendedInfo1("Что делает 3:"
        ...
        , "| 3 + LMB: Оповестить о работе ФСБ в мегафон"
