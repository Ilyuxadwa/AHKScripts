...
Numpad4::Goto СобесПроЛицензии
Numpad5::Goto СобесЛицензии
...
:?*:хелпу1::/d [МО] - [ГО] МВД, ФСБ. На воинскую часть готовится нападение. Срочно требуется подкрепление{!}
:?*:хелпу2::/d [МО] - [ГО] МВД, ФСБ. На воинскую часть произошло нападение. Срочно требуется подкрепление{!}
:?*:хелп-конвой1::/d [МО] - [ГО] МВД, ФСБ. Требуется доп. сопровождение для конвоя{!}
:?*:хелп-конвой2::/d [МО] - [ГО] МВД, ФСБ. Требуется доп. сопровождение для конвоя{!} Мы ожидаем на секретной базе.
:?*:хелп-конвой-фсб1::/d [МО] - [ФСБ] Требуется доп. сопровождение для конвоя{!}
...
F9 & Numpad0::
    ExtendedInfo("Что делает Numpad0:"
        , "Режим: Обычный"
        , "| N0: Приветсвие"
        , "| N0 + LAlt: Только Удостоверение"
        , "| N0 + Ctrl: Посторонний на ВЧ"
        , "Режим: Строй"
        , "| N0: Сбор строя 3 мин, повседневная форма"
        , "| N0 + LAlt: Сбор строя 5 мин, повседневная форма"
        , "| N0 + Ctrl: Сбор строя 3 мин, боевая форма"
        , "| N0 + RAlt: Сбор строя 5 мин, боевая форма"
        , "Режим: Призыв"
        , "| N0: Вопрос"
        , "| N0 + LAlt: Начать собес"
        , "| N0 + Ctrl: Годен")
Return
...
F9 & Numpad2::
    ExtendedInfo("Что делает Numpad2:"
        , "Режим: Обычный"
        , "| N2: Информация про конвой"
        , "Режим: Строй"
        , "| N2: Лекция 1"
        , "Режим: Призыв"
        , "| N2: Попросить мед. карту")
Return
...
F9 & Numpad5::
    ExtendedInfo("Что делает Numpad5:"
        , "Режим: Обычный"
        , "| N5: Конвой на базу"
        , "| N5 + LAlt: Конвой в другую организацию"
        , "Режим: Строй"
        , "| N5: Лекция 4"
        , "Режим: Призыв"
        , "| N5: Взять лицензии")
...
F9 & Numpad7::
    ExtendedInfo("Что делает Numpad7:"
        , "Режим: Обычный"
        , "| N7: Мегафон"
        , "| N7 + LAlt: Занять гос. волну (Только для Генерала)"
        , "| N7 + Ctrl: Ввести режим ЧС (Только для Генерала)"
        , "| N7 + RAlt: Отменить режим ЧС (Только для Генерала)"
        , "Режим: Строй"
        , "| N7: Лекция 6"
        , "Режим: Призыв"
        , "| N7: Вопрос 2")
...
F9 & Numpad8::
    ExtendedInfo("Что делает Numpad8:"
        ...
        , "| N8: Принять"
        , "| N8 + LAlt: Повысить"
        , "| N8 + Ctrl: Выдать взвод"
        , "| N8 + RAlt: Занести в ЧС"
        , "Режим: Строй"
        , "| N8: Лекция 7"
        , "Режим: Призыв"
        , "| N8: РП термины")
...
F9 & Numpad9::
    ExtendedInfo("Что делает Numpad9:"
        , "Режим: Обычный"
        , "| N9: Выговор"
        , "| N9 + LAlt: Снять выговор"
        , "| N9 + Ctrl: Уволить"
        , "| N9 + RAlt: Уволить оффлайн"
        , "Режим: Строй"
        , "| N9: Тренировка"
        , "Режим: Призыв"
        , "| N9: Отказ - Неумение РП"
        , "| N9 + LAlt: Отказ - паспорт"
