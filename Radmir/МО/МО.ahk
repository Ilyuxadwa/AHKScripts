...
:?*:сречь::/r Рядовой  успешно сдал речь{!}{Left 19}
:?*:сприсягу::/r Рядовой  успешно сдал присягу{!}{Left 22}
:?*:сустав::/r Рядовой  успешно сдал устав Мин. Обороны{!}{Left 33}
:?*:патруль-нач::
...
Sleep 1000
SendInput, {F6}/n Все должно быть с РП отыгровками в чат: /me, /do, без использования АХК.{Enter}
Sleep 1000
...
СобесПсих1:
SendMessage, 0x50,, 0x4190419,, A
SendInput, {F6}Отлично, с документами у Вас всё в порядке.
Sleep 1000
SendInput, {F6}Дальше мне нужно задать вам несколько вопросов...
Sleep 1000
